...
namespace LEGODeviceUnitySDK
{
    public abstract class AbstractLEGODevice : ILEGODevice
    {
        ...
        public sealed class DeviceType : IEquatable<DeviceType>
        {
            ...
            public static readonly DeviceType Hub131 = new DeviceType(DeviceSystemType.LEGOTechnic1, systemDeviceNumber: 3); // Gecko Hub
        ...
        protected readonly ILEGODeviceConfig lEGODeviceConfig;
        ...
        public AbstractLEGODevice(IBleDevice bleDevice, ILEGODeviceConfig lEGODeviceConfig)
        {
            this.bleDevice = bleDevice;
            this.lEGODeviceConfig = lEGODeviceConfig;
            SetDeviceBehaviours(new List<BehaviourType>((int)BehaviourType.Regular));
        }
        ...
        internal/*protected*/ void SendPacket(byte[] data, PacketDroppingInfo? packetDroppingInfo) {
            ...
            // If device behaviour is set to packet loss we dont send any packets
            if (DeviceBehaviours.Contains(BehaviourType.PacketLoss))
                return;
        ...
        internal SendStrategy SendStrategyForDevice 
        {
            get
            {
                ...
                else if (deviceType.Equals(DeviceType.Hub32)) // duplo train
                {
                    return SendStrategy.HardAck;
                }
                else if (deviceType.Equals(DeviceType.Hub64)) // boost hub
                {
        ...
        public List<BehaviourType> DeviceBehaviours { get; private set; } = new List<BehaviourType>();
        public void SetDeviceBehaviours(List<BehaviourType> behaviourTypes)
        {
            DeviceBehaviours = behaviourTypes;
        }
        ...
        public void FirmwareTransferStarted()
        {
            if (DeviceBehaviours.Contains(BehaviourType.TransferDisconnect))
            {
                Disconnect();
            }
        }
