...
namespace LEGODeviceUnitySDK
{
    ...
    */
    internal class ConnectInterrogationTimer 
    {
        ...
        public ConnectInterrogationTimer(MonoBehaviour coroutineHelper, Func<bool> servicesAreFullyKnown, Action<bool> onCompletion, ILEGODeviceConfig lEGODeviceConfig)
        {
        ...
        private void TerminateInterrogation(bool success)
        {
            ...
            CurrentState = success || legoDeviceConfig.IgnoreFailedInterrogationEvents ?
                            InterrogationState.Complete :
                            InterrogationState.Failed;
        ...
        private void CheckWhetherDone()
        {
            ...
            if (legoDeviceConfig.IgnoreFailedInterrogationEvents == false)
                isDone &= CurrentState == InterrogationState.InProgress;
