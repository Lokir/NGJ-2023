...
{
    /*
     * This script will attempt to fit UI within the SafeArea of the given device, to avoid rendering on camera cutout.
     * Attach to a GameObject holding the Canvas component for some UI. Expects to find a child gameobject with name "SafeArea" to perform resizing on.
     */
