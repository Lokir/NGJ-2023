...
namespace LEGODeviceUnitySDK
{
    public class DevicePort
    {
        ...
        public static readonly DevicePort InternalTemperatureSensor = new DevicePort {PortLabelString = "InternalTemperatureSensor", PortLabelIndex = 16};
        public static readonly DevicePort InternalGyroscopeSensor = new DevicePort {PortLabelString = "InternalGyroscopeSensor", PortLabelIndex = 17};
        public static readonly DevicePort InternalGestureSensor = new DevicePort {PortLabelString = "InternalGestureSensor", PortLabelIndex = 18};
        ...
        private static readonly List<DevicePort> allPorts = new List<DevicePort>
        {
            ...
            InternalTemperatureSensor, InternalGyroscopeSensor,
            InternalGestureSensor,
        };
        ...
        private static readonly List<DevicePortMap> portMaps = new List<DevicePortMap>
        {
            ...
            // Hub131 - Gecko
            new DevicePortMap(new LEGORevision(0, 0, 0, 0),
                DeviceSystemType.LEGOTechnic1, 3, new Dictionary<DevicePort, int> {{A, 0}, {B, 1}, {Virtual1, 16}, {InternalRGBLight, 49}, {InternalCurrentSensor, 59}, {InternalVoltageSensor, 60}, {InternalGestureSensor, 95}, {InternalTemperatureSensor, 96}, {InternalAccelerometer, 97}, {InternalGyroscopeSensor, 98}, {InternalOrientationAngleSensor, 99}},
                new [] {IOType.LEIOTypeMotorWithTacho, IOType.LEIOTypeTechnicMotorL, IOType.LEIOTypeTechnicMotorXL, IOType.LEIOTypeTechnicAzureAngularMotorM, IOType.LEIOTypeTechnicAzureAngularMotorL, IOType.LEIOTypeTechnicGreyAngularMotorM, IOType.LEIOTypeTechnicGreyAngularMotorL, IOType.LEIOTypeTechnicAzureAngularMotorS},
                new [] {new VirtualPortPair(A, B)}),
        };
