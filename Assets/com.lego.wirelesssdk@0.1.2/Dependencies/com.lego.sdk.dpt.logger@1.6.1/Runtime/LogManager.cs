...
namespace LEGO.Logger
{
    ...
    public class LogManager : IDisposable
    {
        ...
        public static ILogAppender GetAppender(Type appenderType)
        {
            foreach (var appender in Appenders) // or could use TryGetValue maybe with predicate to test typeof
            {
                if (appenderType == appender.GetType())
                {
                    return appender;
                }
            }
        ...
        [SuppressMessage("ReSharper", "UnusedMember.Global")]
        public static void UseRuntimeLogView(bool shownByDefault = false)
        {
            ...
            (appender as MonoBehaviour)?.gameObject.SetActive(shownByDefault);
        }
