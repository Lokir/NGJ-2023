        ...
        public class Builder
        {
            ...
            private LEGOService DoBuild()
            {
                switch (connectInfo.Type)
                {
                    ...
                    case IOType.LEIOTypeGeckoLEDMatrix:
                        return new LEGOLEDMatrix(this);
                    case IOType.LEIOTypeChargingLight:
                        return new LEGOChargingLight(this);
                    ...
                    case IOType.LEIOTypeTechnicThreeAxisGestureSensor:
                        return new LEGOTechnic3AxisGestureSensor(this);
