...
namespace LEGODeviceUnitySDK
{
    ...
    public interface ILEGODevice
    {
        ...
        /// <summary>
        /// The Device Behaviour dictates how the LDSDK will behave given the device.
        /// The different behaviours are meant to test different faulty behaviours that might occur from a device.
        /// </summary>
        List<BehaviourType> DeviceBehaviours { get; }
        
        /// <summary>
        /// Used to set a list of specific behaviours for the device.
        /// </summary>
        void SetDeviceBehaviours(List<BehaviourType> behaviourTypes);
    ...
    */
    ...
    {
        /// <summary>
        /// The LDSDK treats the device normally
        /// </summary>
        Regular,
        /// <summary>
        /// The LDSDK will fail during interrogation
        /// </summary>
        InterrogationFailure,
        /// <summary>
        /// The LDSDK will disconnect the hub during firmware transfer
        /// </summary>
        TransferDisconnect,
        /// <summary>
        /// The LDSDK will not send packets to the BLE device
        /// </summary>
        PacketLoss
    }
