...
namespace LEGODeviceUnitySDK
{
    public class DeviceListTracker
    {
        ...
        public void OnDeviceAppeared(IBleDevice bleDevice, ILEGODeviceConfig lEGODeviceConfig)
        {
            new PendingDevice(bleDevice, lEGODeviceConfig,
        ...
        private class PendingDevice 
        {
            ...
            public PendingDevice(IBleDevice bleDevice, ILEGODeviceConfig lEGODeviceConfig, Action<AbstractLEGODevice> onInstantiated)
            {
            ...
            private void OnDeviceStateChanged()
            {
                ...
                var device = CreateDeviceForGattService(bleDevice, serviceGuid, lEGODeviceConfig);
        ...
        internal void OnDeviceStateChanged(BleDevice bleDevice)
        {
            ...
            if (!devices.TryGetValue(deviceID, out device)) {
                ...
                device = AssignNextSortingKey(CreateDeviceForGattService(bleDevice, serviceGuid, null)); //This OnDeviceStateChanged isn't used anywhere.
                if (device == null) {
                    // Unsupported device type - ignore.
        ...
        private static AbstractLEGODevice CreateDeviceForGattService(IBleDevice bleDevice, Guid serviceGUID, ILEGODeviceConfig lEGODeviceConfig)
        {
            switch (serviceGUID.ToString()) {
            case LEGODevice.V3_SERVICE:
                return new LEGODevice(bleDevice, lEGODeviceConfig);
