...
namespace LEGODeviceUnitySDK
{
    ...
    public static class IOTypes
    {
        ...
        public static readonly ICollection<IOType> LEDMatrices = new List<IOType>
        {
            IOType.LEIOTypeGeckoLEDMatrix
        };
    ...
    // If it's a sensor then if there is a reporter block for it that is compatible or is able to recognize the sensor
    // then consider adding the IOType to the hardware_type_ids of the appropriate sensor BlockDefinition.json file.
    public enum IOType
    {
        LEIOTypeGeneric = 0,
        LEIOTypeMotor = 1,
        ...
        LEIOTypeTechnicThreeAxisGestureSensor = 54,
