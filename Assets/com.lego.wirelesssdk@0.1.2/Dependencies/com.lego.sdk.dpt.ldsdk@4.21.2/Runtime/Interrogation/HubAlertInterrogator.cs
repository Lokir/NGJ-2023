...
namespace LEGODeviceUnitySDK
{
    ...
    internal class HubAlertInterrogator : CheckListBase<HubAlert, Void, Void>
    {
        ...
        private BehaviourType deviceBehaviourType;
        ...
        {
            // If interrogation should fail, we do not check off on any alerts
            if (device.DeviceBehaviours.Contains(BehaviourType.InterrogationFailure))
                return;
            CheckOff(alert);
        }
        #endregion
